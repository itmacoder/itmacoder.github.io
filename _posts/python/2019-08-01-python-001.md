...
](http://www.itmacoder.com/python/2019/02/21/python-history.html)。
...
我选择使用 Sublime Text ，因为它轻量级，并且我一直使用这个工具写文章，感觉很不错，关于 Sublime Text 3 的快捷键可以查看此文章[Sublime3 使用总结](http://www.itmacoder.com/other/2015/11/12/sublime3-summary.html)。
